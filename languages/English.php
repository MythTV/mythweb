...
$Categories['Children']       = array('Children',         '\\b(?:child|kin?d|infan|animation)');
$Categories['Comedy']         = array('Comedy',           '\\b(?:comed|entertain|sitcom)');
$Categories['Crime_Mystery']  = array('Crime / Mystery',  '\\b(?:[ck]rim|myster)');
$Categories['Documentary']    = array('Documentary',      '\\b(?:do[ck])');
$Categories['Drama']          = array('Drama',            '\\b(?:drama)');
$Categories['Educational']    = array('Educational',      '\\b(?:edu|bildung|interests)');
$Categories['Food']           = array('Food',             '\\b(?:food|cook|essen|[dt]rink)');
$Categories['Game']           = array('Game',             '\\b(?:game|spiele)');
$Categories['Health_Medical'] = array('Health / Medical', '\\b(?:health|medic|gesundheit)');
...
$Categories['News']           = array('News',             '\\b(?:news|nachrichten|current)');
...
$Categories['Science_Nature'] = array('Science / Nature', '\\b(?:science|nature|environment|wissenschaft)');
...
$Categories['Sports']         = array('Sports',           '\\b(?:sport|deportes|futbol)');
$Categories['Talk']           = array('Talk',             '\\b(?:talk)');
$Categories['Travel']         = array('Travel',           '\\b(?:travel|reisen)');
$Categories['War']            = array('War',              '\\b(?:war|krieg)');

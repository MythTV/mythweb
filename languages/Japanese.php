...
define ('_LANG_RECORD_ONLY_THIS_SHOWING', 'この放送のみ録画する');
define ('_LANG_RECORD_THIS_PROGRAM_IN_THIS_TIMESLOT_EVERY_DAY', 'この番組を毎日この時間帯に録画する');
define ('_LANG_RECORD_THIS_PROGRAM_IN_THIS_TIMESLOT_EVERY_WEEK', 'この番組を毎週この時間帯に録画する');
define ('_LANG_ALWAYS_RECORD_THIS_PROGRAM_ON_CHANNEL', 'この番組をこのチャンネルで録画する');
define ('_LANG_ALWAYS_RECORD_THIS_PROGRAM_ON_ANY_CHANNEL', '個の番組をどのチャンネルでも録画する');
define ('_LANG_RECORD_ONE_SHOWING_OF_THIS_PROGRAM_AT_ANY_TIME', '個の番組を一回だけ録画する');
...
/* search.php */
define ('_LANG_NO_MATCHES_FOUNDT', '一致する物が有りませんでした');
define ('_LANG_SEARCH', '検索');

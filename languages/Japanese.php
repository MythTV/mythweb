...
define ('_LANG_SCHEDULED_RECORDINGS',   '録画番組');
...
define ('_LANG_CATMATCH_ACTION',            'アクション');
define ('_LANG_CATMATCH_ADULT',             'アダルト');
define ('_LANG_CATMATCH_ANIMALS',           '動物');
define ('_LANG_CATMATCH_ART_MUSIC',         '(芸術|音楽)');
define ('_LANG_CATMATCH_BUSINESS',          'ビジネス');
define ('_LANG_CATMATCH_CHILDREN',          'アニメ');
define ('_LANG_CATMATCH_COMEDY',            'コメディー');
define ('_LANG_CATMATCH_CRIME_MYSTERY',     '(犯罪|ミステリー)');
define ('_LANG_CATMATCH_DOCUMENTARY',       'ドキュメンタリー');
define ('_LANG_CATMATCH_DRAMA',             'ドラマ');
define ('_LANG_CATMATCH_EDUCATIONAL',       '教養');
define ('_LANG_CATMATCH_FOOD',              '食事');
define ('_LANG_CATMATCH_GAME',              'ゲーム');
define ('_LANG_CATMATCH_HEALTH_MEDICAL',    '(健康|医療)');
define ('_LANG_CATMATCH_HISTORY',           '歴史');
define ('_LANG_CATMATCH_HOWTO',             'ハウツー');
define ('_LANG_CATMATCH_HORROR',            'ホラー');
define ('_LANG_CATMATCH_MISC',              'バラエティー');
define ('_LANG_CATMATCH_NEWS',              '報道');
define ('_LANG_CATMATCH_REALITY',           'リアリティー');
define ('_LANG_CATMATCH_ROMANCE',           'ロマンス');
define ('_LANG_CATMATCH_SCIENCE_NATURE',    '科学　自然');
define ('_LANG_CATMATCH_SCIFI_FANTASY',     'SF ファンタジー');
define ('_LANG_CATMATCH_SHOPPING',          'ショッピング');
define ('_LANG_CATMATCH_SOAPS',             'メロドラマ');
define ('_LANG_CATMATCH_SPIRITUAL',         '趣味');
define ('_LANG_CATMATCH_SPORTS',            'スポーツ');
define ('_LANG_CATMATCH_TALK',              'トーク');
define ('_LANG_CATMATCH_TRAVEL',            '旅行');
define ('_LANG_CATMATCH_WAR',               '戦争');
define ('_LANG_CATMATCH_WESTERN',           'ウェスタン');
define ('_LANG_CATMATCH_MOVIES',            '映画');

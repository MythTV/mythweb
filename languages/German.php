...
define ('_LANG_KEY_BINDINGS',         'Tastenbindungen');
...
define ('_LANG_RECORDING_PROFILE',         'Aufnahme Profile');
...
define ('_LANG_ALL_RECORDINGS',            'allen Aufnahmen');
define ('_LANG_DUPLICATE_CHECK_METHOD',    'Testmethode f. Duplikate');
...
define ('_LANG_AUTO_EXPIRE_RECORDINGS',    'Autom. Entfernen v. Aufnahmen?');
define ('_LANG_NO_OF_RECORDINGS_TO_KEEP',  'Anzahl der Aufnahmen zum behalten?');
define ('_LANG_RECORD_NEW_AND_EXPIRE_OLD', 'Neues Aufnehmen und altes Entfernen?');
define ('_LANG_START_EARLY',               'Fr&uuml;her Starten (Minuten)');
define ('_LANG_END_LATE',                  'Sp&auml;ter Enden (Minuten)');

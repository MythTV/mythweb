...
define ('_LANG_LISTINGS',       'Programagids');
...
define ('_LANG_RESET',              'Anuleren');
define ('_LANG_SAVE',               'Opslaan');
define ('_LANG_SHOW_DESCRIPTIONS_ON_NEW_LINE',  'Toon omschrijving op nieuwe lijn');
...
define ('_LANG_DUP_METHOD',         'Manier om dubbels te zoeken');
...
define ('_LANG_DUPLICATE_CHECK_METHOD', 'Zoeken op dubbels');
...
define ('_LANG_RECSTATUS_LONG_CURRENTRECORDING',    'Deze aflevering werd reeds opgenomen en is nog steeds in liest met opnames.');
define ('_LANG_RECSTATUS_LONG_OTHERSHOWING',        'Deze aflevering word op een ander moment opgenomen (heruitzending)');

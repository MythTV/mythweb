 ...
 **/
    static function recording_template($name) {
        ...
        $template_params = array(
            'profile', 'autoexpire', 'maxepisodes', 'maxnewest', 'startoffset', 'endoffset',
            'recgroup', 'dupmethod', 'dupin', 'autotranscode', 'autocommflag', 'autouserjob1', 'autouserjob2',
            'autouserjob3', 'autouserjob4', 'autometadata', 'inactive', 'transcoder', 'playgroup',
            'prefinput', 'storagegroup', 'filter');

...
<tr>
	...
	<td align="center"><a href="search.php?title=<?=urlencode($this_program->title)?>">Find other showtimes for this program</a></td>
<? if ($this_program->subtitle) {
?>	<td align="center"><a href="search.php?title=<?=urlencode($this_program->title)?>&subtitle=<?=urlencode($this_program->subtitle)?>">Find other showtimes for this episode</a></td>
<? }
?></tr><tr>
